...
> 🔁 For the evaluation of the methods introduced here, and their implementation on other psychology targets, see: [LSC-Eval](https://github.com/naomibaes/LSCD_method_evaluation/tree/main)
